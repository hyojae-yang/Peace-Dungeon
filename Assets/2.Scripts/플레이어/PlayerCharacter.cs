...
public class PlayerCharacter : MonoBehaviour
{
    ...
    /// <summary>
    /// 모든 하위 시스템(Inventory, Attack, Stats 등)의 초기화가 완료되었음을 외부에 알리는 이벤트입니다.
    /// </summary>
    ...
    private void Start()
    {
        // Awake에서 모든 참조가 완료되었고, 이제 모든 컴포넌트의 Start()가 호출될 차례입니다.
        // 모든 컴포넌트의 Start()가 끝났다고 가정한 후, 최종적으로 초기화 완료를 알립니다.
        // 이 시점(LateUpdate 또는 Start의 마지막)이 가장 안전합니다.
