...
public class FireballProjectile : MonoBehaviour
{
    ...
    // ⭐ 새로 추가: 투사체의 이동 방향을 저장할 변수 (기본값은 로컬 Z축)
    ...
    void Update()
    {
        // ⭐ 수정: 매 프레임마다 파이어볼을 '주입된 방향'으로 이동시킵니다.
        // 기존: transform.Translate(Vector3.forward * moveSpeed * Time.deltaTime);
    ...
    /// <summary>
    /// ⭐ 새로 추가: 외부(FireballSkillData)로부터 투사체의 발사 방향을 주입받는 메서드입니다.
    /// </summary>
    ...
    public void SetDirection(Vector3 direction)
    {
        ...
        // 시각적으로 투사체가 날아가는 방향을 바라보도록 회전시킵니다.
