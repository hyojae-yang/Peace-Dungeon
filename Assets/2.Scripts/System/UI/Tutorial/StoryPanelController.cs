...
public class StoryPanelController : MonoBehaviour
{
    ...
    private void Start()
    {
        // SoundManager 인스턴스 참조 캐시
        _soundManager = SoundManager.Instance;

        // 플레이어 움직임 비활성화 (방어적 코드 추가)
    ...
    public void HandlePlayerInput()
    {
        ...
        if (!isTypingComplete)
        {
            ...
            // 필요하다면 이곳에 _soundManager.PlaySFX(SFXType.skip_sound); 등을 넣을 수 있습니다.
        }
