...
public class RegistrationPanelHandler : MonoBehaviour
{
    ...
    /// <summary>
    /// 등록 버튼 클릭 시 호출됩니다.
    /// 스킬 슬롯 선택 패널 활성화를 부모 SkillIcon에 요청하기 위해 코루틴을 시작합니다.
    /// </summary>
    private void OnRegisterButtonClick()
    {
        // 첫 클릭 누락 문제를 해결하기 위해 로직 실행을 한 프레임 지연시킵니다.
        StartCoroutine(Co_ShowSlotSelectionPanel());
    }

    /// <summary>
    /// 등록 패널 활성화 로직을 다음 프레임에 수행합니다. (첫 클릭 이슈 해결)
    /// </summary>
    private IEnumerator Co_ShowSlotSelectionPanel()
    {
